...
def chunk_text(text: str, max_tokens=300, overlap=40, model="gpt-3.5-turbo") -> List[str]:
    enc = tiktoken.get_encoding("cl100k_base") if "gpt" in model else tiktoken.get_encoding("cl100k_base")
